  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-6 z-50 pointer-events-auto">
        ...
        {openMenu && (
          <div
            className="absolute bottom-20 left-0 w-48 bg-white dark:bg-gray-800 
                       shadow-lg rounded-xl border border-gray-200 dark:border-gray-700 
          ...
          >
            <button
              ...
              className="flex items-center gap-2 w-full px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
            >
              <Bot size={20} />
      ...
      {/* شريط التنقل السفلي */}
      <div className="fixed bottom-6 w-full px-6 z-40 flex items-center justify-between pointer-events-none">
        {/* زر + (في الوسط) */}
